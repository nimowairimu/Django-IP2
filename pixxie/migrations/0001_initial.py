    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('profile', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='pixxie.profile')),
            ],
        ),
        migrations.CreateModel(
            name='Followwww',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('postt', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='pixxie.image')),
                ('userr', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='pixxie.profile')),
            ],
        ),
    ]
